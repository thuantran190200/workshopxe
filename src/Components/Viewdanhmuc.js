...
export class Viewdanhmuc extends Component {
              ...
              <section class="hoc container clear"> 
                 ...
                 <div class="row">
                {
                              ...
                              return  (
                                ...
                                <h4 type="color:red">Giá: {item.Gia.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} VNÐ</h4>
                                <div class="rating">
...
export default connect(mapStateToProps,mapDispatchToProps)(Viewdanhmuc)
